...
class FSStub(object):
    ...
    def __init__(self, channel):
        ...
        self.OpenFile = channel.unary_unary(
                '/FS/OpenFile',
                request_serializer=file__system__pb2.Path.SerializeToString,
                response_deserializer=file__system__pb2.ResultadoOpen.FromString,
                )
        self.ReadFile = channel.unary_unary(
                '/FS/ReadFile',
                request_serializer=file__system__pb2.ReadFileParameters.SerializeToString,
                response_deserializer=file__system__pb2.ResultadoRF.FromString,
                )
        self.CloseFile = channel.unary_unary(
                '/FS/CloseFile',
                request_serializer=file__system__pb2.Path.SerializeToString,
                response_deserializer=file__system__pb2.ResultadoClose.FromString,
                )
...
def add_FSServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'OpenFile': grpc.unary_unary_rpc_method_handler(
                    servicer.OpenFile,
                    request_deserializer=file__system__pb2.Path.FromString,
                    response_serializer=file__system__pb2.ResultadoOpen.SerializeToString,
            ),
            'ReadFile': grpc.unary_unary_rpc_method_handler(
                    servicer.ReadFile,
                    request_deserializer=file__system__pb2.ReadFileParameters.FromString,
                    response_serializer=file__system__pb2.ResultadoRF.SerializeToString,
            ),
            'CloseFile': grpc.unary_unary_rpc_method_handler(
                    servicer.CloseFile,
                    request_deserializer=file__system__pb2.Path.FromString,
                    response_serializer=file__system__pb2.ResultadoClose.SerializeToString,
            ),
    }
...
class FS(object):
    ...
    def OpenFile(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/FS/OpenFile',
            file__system__pb2.Path.SerializeToString,
            file__system__pb2.ResultadoOpen.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReadFile(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/FS/ReadFile',
            file__system__pb2.ReadFileParameters.SerializeToString,
            file__system__pb2.ResultadoRF.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CloseFile(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/FS/CloseFile',
            file__system__pb2.Path.SerializeToString,
            file__system__pb2.ResultadoClose.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
